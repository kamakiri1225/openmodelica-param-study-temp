...
equation
  ...
  annotation(
    ...
    Diagram(coordinateSystem(extent = {{-260, 400}, {420, -240}}), graphics = {Text(origin = {95, 352}, extent = {{-67, 36}, {67, -36}}, textString = "mist remover排気中のmist/空気の質量比が一定であると仮定を置く。
（mist remover air供給の操作に連動して取り除くmistの流量が変化する。）"), Text(origin = {281, 240}, extent = {{-71, 10}, {71, -10}}, textString = "mist除去による水の質量と熱量の喪失する現象を、
