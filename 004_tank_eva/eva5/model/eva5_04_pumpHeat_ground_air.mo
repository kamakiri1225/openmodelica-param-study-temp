// ============================================================
//  eva5_04_pumpHeat_ground_air   (pumpHeat + groundLoss + airLoss に集約・自己完結)
//  version 1.3.0  (2026-09-25)
//  物理は 01 と等価。加熱も放熱(地面・外気)も全て部品化。1ファイルで開けばよい。
//  解説は eva5/docs/ を参照。
// ============================================================
model eva5_04_pumpHeat_ground_air
...
equation
  ...
  annotation(
    ...
    version = "1.0.0");
end eva5_04_pumpHeat_ground_air;
