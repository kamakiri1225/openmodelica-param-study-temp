// ============================================================
//  ana003_Tank3blocks_cyclononly_NoTemp   (eva5)
//  version 1.0.0  (2026-08-31)
//  eva5: 3槽・サイクロン投入熱610W・温度管理なし(自由昇温)。
//  実測(2026-07-09)にRMSE0.24℃で合わせこみ(level_start=0.0755, heatCeffToAir=8.79)。
//  変更履歴・パラメータ/熱伝達率の解説は eva5/docs/ を参照。
// ============================================================
