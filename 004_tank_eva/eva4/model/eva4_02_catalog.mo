// ============================================================
//  eva4_02_catalog   (eva5_04 全部品化 + 温度管理 TempControl)
...
Tsensで水温を測り、PID(ctrl_k)がcoolerで除熱してTtargetに保持する。ctrl_k=0で管理OFF。</p></html>"));
  ...
  TempControl tempControl(redeclare package Medium = fluid1, Ttarget = Ttarget, ctrl_k = 2000, cooling_capacity = 3500, flow_Lmin = 25, T_start = T_ini) annotation(
...
equation
  ...
  connect(tank1.ports[3], tempControl.port_a) annotation(
    Line(points = {{12, -6}, {12, 96}, {100, 96}}, color = {0, 127, 255}, thickness = 0.5));
