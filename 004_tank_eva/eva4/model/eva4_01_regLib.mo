// ============================================================
//  eva4_01_regLib   (eva5_04 全部品化 + 温度管理 TempControl)
...
Tsensで水温を測り、PID(ctrl_k)がcoolerで除熱してTtargetに保持する。ctrl_k=0で管理OFF。</p></html>"));
  ...
  TempControl tempControl(redeclare package Medium = fluid1, Ttarget = Ttarget, ctrl_k = 2000, cooling_capacity = 1e9, flow_Lmin = 25, T_start = T_ini) annotation(
