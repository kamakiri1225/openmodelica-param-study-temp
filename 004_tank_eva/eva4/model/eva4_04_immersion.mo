// ============================================================
//  eva4_04_immersion   (eva5_04 全部品化 + 温度管理 TempControl)
...
// ============================================================
model eva4_04_immersion
  extends Modelica.Icons.Example;
  import Modelica.Fluid.Vessels.BaseClasses.VesselPortsData;
  //--- 再利用部品: 浸漬形オイルコン(タンクに沈めた冷却コイル。目標温度Ttargetに向けて冷媒温度をゆっくり調整) ---
...
enabled=falseで除熱0(温度管理なし)。</p></html>"));
  ...
  ImmersionCooler immCooler(Ttarget = 24.5, UA_cool = 57, Tcool_init = 14, enabled = true) annotation(
