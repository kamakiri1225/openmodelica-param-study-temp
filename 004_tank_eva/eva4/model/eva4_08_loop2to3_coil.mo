// ============================================================
//  eva4_08_loop2to3_coil   (eva5_04 全部品化 + 温度管理 TempControl)
...
タンクの管理温度を下げたい→Tcoolを下げる。enabled=falseで除熱0(管理OFF=eva5相当)。</p></html>"));
  ...
  CoolingCoilCtrl coilCtrl(redeclare package Medium = fluid1, Tcool = 14, UA_cool = 57, flow_Lmin = 25, T_start = T_ini) annotation(
...
equation
  ...
  connect(tank2.ports[3], coilCtrl.port_a) annotation(
