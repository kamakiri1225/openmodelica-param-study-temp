// ============================================================
//  eva4_05_localSensor   (eva5_04 全部品化 + 温度管理 TempControl)
...
冷却のみ、除熱上限 capacity。enabled=falseで除熱0。</p></html>"));
  ...
  SensorCooler sCooler(Ttarget = 24.5, capacity = 3500, m_local = 10, flow_Lmin = 25, sensorAtPumpOut = false, enabled = true) annotation(
