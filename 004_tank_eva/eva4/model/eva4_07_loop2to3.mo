// ============================================================
//  eva4_07_loop2to3   (eva5_04 全部品化 + 温度管理 TempControl)
...
equation
  ...
  connect(tank2.ports[3], tempControl.port_a) annotation(
    Line(points = {{140, 0}, {140, -12}, {90, -12}, {90, 96}, {100, 96}}, color = {0, 127, 255}, thickness = 0.5));
